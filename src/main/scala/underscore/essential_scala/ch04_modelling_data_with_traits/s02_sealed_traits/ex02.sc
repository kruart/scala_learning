...
case object Red extends Color {
  // Here we have implemented the RGB values as `vals` because the values cannot change:
  val red = 1.0
  val green = 0.0
  val blue = 0.0
}
...
// Test code:
Draw(Circle(10, Pink)) // res29: String = A pink circle of radius 10.0cm
Draw(Rectangle(3, 4, CustomColor(0.4, 0.4, 0.6))) // res30: String = A dark rectangle of width 3.0cm and height 4.0cm
